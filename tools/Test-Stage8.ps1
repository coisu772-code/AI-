...
try {
    ...
    if ($null -eq $binding -or -not [bool]$binding.executed -or [string]$binding.classification -ne "local-evidence" -or [string]$binding.evidence.implementationSourceCommitSha -ne "53f9d2cc70f58408d013ee18e5d190a04562d2ab") {
    ...
    $summary = [ordered]@{
        ...
        implementationSourceBinding="PASS"; implementationSourceCommit="53f9d2cc70f58408d013ee18e5d190a04562d2ab"; externalActionsExecuted=$false; approvalChecklist=(Join-Path $root "docs\final-acceptance-approval-checklist-v0.8.0-rc.2.json")
    }

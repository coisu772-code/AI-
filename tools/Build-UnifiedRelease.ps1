...
& $uv.Source run python (Join-Path $root "tools\build_unified_release.py") --output $OutputRoot --runtime-source $RuntimeSource --uv $uv.Source --workshop-dir $WorkshopAssetRoot --publisher-dir $PublisherAssetRoot --kokoro-dir $KokoroAssetRoot

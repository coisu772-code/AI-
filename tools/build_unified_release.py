...
WORKSHOP_SHA = "fed84fcabaeefb2beffdc02197dcf6ae24c8f25c2df27ef1762f986c5fe0ee45"
WORKSHOP_SIZE = 157745103
WORKSHOP_ROOT = "Z-Manga-Workshop-2.9.0-rc.1-for-AIVCP-0.16.0-rc.1-windows-x64-portable"
WORKSHOP_SOURCE_COMMIT = "538d541ce1f9153712b14cc07efebae5dae3729e"
...
def build_all(output: Path, runtime_source: Path, uv: Path, workshop_dir: Path, publisher_dir: Path, deno_archive: Path | None = None, runtime_asset: Path | None = None) -> dict[str, object]:
    ...
    manifest = {
        ...
        "generatedAt":"2026-08-30T00:00:00Z","assets":assets,"optionalRuntimePackages":kokoro_packages,

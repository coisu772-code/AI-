...
& (Join-Path $PSScriptRoot "Install-AIVideoChannelProduction.ps1") -ManifestPath $ManifestPath -AssetRoot $AssetRoot -DownloadBaseUrl $DownloadBaseUrl -InstallMode $InstallMode -InstallRoot $installFull -DataRoot $DataRoot -SkipCodexRegistration:$SkipCodexRegistration -Force

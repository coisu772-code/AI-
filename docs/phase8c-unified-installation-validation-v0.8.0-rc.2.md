...
- 统一入口和核心资产已绑定 implementation/source commit `53f9d2cc70f58408d013ee18e5d190a04562d2ab`；后续仅含绑定与发行哈希的 metadata commit 不会冒充资产源码绑定。总清单不存在 commit 占位，发布预检会拒绝占位清单。此项是已完成的本地证据，不是外部批准门。

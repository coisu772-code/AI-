...
当前预发布候选版本是 `v0.13.0-rc.1`。本版加入项目级配音引擎与音色锁、Seed Audio 短音效、Codex 视觉计划 schema 1.3、失败镜头范围锁，以及新漫剧工坊 `2.6.0-rc.1` 的固定音色库、凭据隔离、任务恢复和成片时序修复。系统不会代替用户执行 Google／YouTube OAuth。

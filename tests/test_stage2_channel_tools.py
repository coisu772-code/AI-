...
class Stage2ToolTestCase(unittest.TestCase):
    ...
    def test_confirmed_auto_upload_default_requires_ready_publisher_channel(self) -> None:
        ...
        self.assertEqual(caught.exception.code, "AUTO_UPLOAD_NOT_AVAILABLE_STAGE2")
